...
const Footer = () => {
    ...
    <ul className="footer-menu">
        <li className="footer-menu-item">Created by <span className="footer-icon">Roman Jasiek</span> in 2021 with <FontAwesomeIcon className="footer-icon" icon={faHeart}/>, <FontAwesomeIcon className="footer-icon" icon={faCoffee}/> and incredible support from <span className="footer-icon">Ghassan Aldarwish</span> in Magdeburg</li>
